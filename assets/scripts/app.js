...
$(() => {
  ...
  $('#examples-index').on('submit', gameEvents.onIndex)
  $('#examples-show').on('submit', gameEvents.onShow)
  $('#examples-destroy').on('submit', gameEvents.onDestroy)
  $('#examples-update').on('submit', gameEvents.onUpdate)
})
